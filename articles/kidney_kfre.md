...
risk. Includes NA policies, high-missingness warnings, optional extreme
scanning with warn/cap/NA/error behaviors, and verbose summaries. Units:
age (years), sex coded 1=male/2=female, eGFR (mL/min/1.73 m^2), UACR
(mg/g); no unit conversion is performed.
...
flagged values before calculation.
...
- Extreme defaults: age 18–120, eGFR 1–200, UACR 0.1–10000 mg/g. Adjust
  via `extreme_rules` if needed.
...
- Tighten extreme bounds for your cohort; keep `verbose = TRUE` while
  setting them.
