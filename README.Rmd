...
**Step 1 — call `hm_col_report()` first** to see which columns are auto-detected
...
**Step 2 — copy the printed `col_map` template** and fill in your column names
