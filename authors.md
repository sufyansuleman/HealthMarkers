...
Suleman, S. (2026). HealthMarkers: Clinical Marker Calculators and
Indices. R package version 0.1.1.
https://github.com/sufyansuleman/HealthMarkers

    @Manual{,
      title = {HealthMarkers: Clinical Marker Calculators and Indices},
