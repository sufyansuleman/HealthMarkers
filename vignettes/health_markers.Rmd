...
vignette: >
  %\VignetteIndexEntry{Health marker aggregators}
...
## Verbose diagnostics
Set `verbose = TRUE` (and `healthmarkers.verbose = "inform"`) to surface three structured messages on each call: preparing inputs, a column mapping summary, and a group execution summary.
...
across all marker categories, and get a ready-to-paste `col_map` template for
any that are not. See the [Multi-Biobank Compatibility](articles/multi_biobank.html)
