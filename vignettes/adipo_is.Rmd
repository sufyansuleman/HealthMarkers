...
`adipo_is()` computes adipose-related insulin sensitivity/resistance indices from fasting glucose, insulin, lipids, FFA, and adiposity. Units are converted internally (glucose mmol/L→mg/dL, insulin pmol/L→µU/mL, TG mmol/L→mg/dL, HDL mmol/L→mg/dL). Optional normalization can be applied to outputs.
