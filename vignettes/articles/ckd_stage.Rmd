...
2. **Column map** — confirms which data column each required key (`eGFR`, `UACR`) resolved to.
   Example: `ckd_stage(): column map: eGFR -> 'eGFR', UACR -> 'UACR'`
3. **Results summary** — shows how many rows computed successfully (non-NA) per output column.
   Example: `ckd_stage(): results: ckd_g_stage 30/30, ckd_a_stage 28/30, ckd_stage 28/30, ...`
