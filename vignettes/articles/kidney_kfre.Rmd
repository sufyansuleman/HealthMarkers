...
## Scope
4-variable Kidney Failure Risk Equation (KFRE) for 2- and 5-year ESKD risk. Includes NA policies, high-missingness warnings, and verbose summaries. Units: age (years), sex coded 1=male/2=female, eGFR (mL/min/1.73 m^2), UACR (mg/g). Supply UACR in mg/g; it is converted internally to mg/mmol (÷8.84) for the equation, which is defined in mg/mmol.
...
## Tips
- Provide UACR in mg/g (the US convention); the function converts to mg/mmol (÷8.84) internally. Do **not** pre-convert to mg/mmol, or it will be double-converted.
