...
```
*Interpretation:* Implausible volumes are set to NA before calling; GLI fields are computed when `rspiro` is available, otherwise fall back or remain NA. Bronchodilator deltas are percent changes pre→post.
